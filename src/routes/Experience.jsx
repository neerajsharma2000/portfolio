...
const Experience = () => {
  return (
    <div
      ...
      className="w-full h-screen flex flex-col justify-center items-center bgpic"
    >
      {/* <Navbar /> */}
      ...
      <div className="w-full h-screen flex flex-col justify-center items-center  text-blue-400 ">
        <div className="w-max-[1000px]  mx-auto p-4 flex justify-center items-center  bg-black opacity-80 ">
          <h1 className="text-2xl md:text-4xl md:font-bold rounded-md hover:bg-blue-400 hover:text-black">
            Skills
          </h1>
        </div>
        <div className="w-max-[1000px]   flex bg-black opacity-80">
          <div className="flex mx-4 justify-center items-center  w-20 h-20">
