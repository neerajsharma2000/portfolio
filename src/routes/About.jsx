      ...
      <div className='w-full h-screen flex flex-col justify-center items-center  text-blue-400  '>
        ...
        <div className="max-w-[1000px]  mx-auto p-2 flex-col md:flex  bg-black opacity-80">
          <div className="flex justify-center items-center ">
            <h1 className="text-2xl md:text-4xl md:font-extrabold hover:bg-blue-400 hover:text-black rounded-md">About</h1>
          </div>
        ...
        <div className="max-w-[1000px]  flex-col justify-center items-center  bg-black opacity-80">
          <div className="flex-col justify-center items-center">
            <h1 className="text-2xl md:text-3xl md:font-extrabold">Chaipoint| Java, Springboot,MySQL</h1>
          ...
          <div className="flex-col justify-center items-center">
            <h1 className="text-2xl md:text-3xl md:font-extrabold">EISystems Services| Python, Flask,Bootstrap</h1>
          ...
          <div className="flex-col justify-center items-center">
            <h1 className="text-2xl md:text-3xl md:font-extrabold">Bachelor of Technology,C.S.E</h1>
            <p>Madan Mohan Malaviya University of Technology,Gorakhpur</p>
            <p>2018-2022</p></div>
          <div className="flex-col justify-center items-center">
            <h1 className="text-2xl md:text-3xl md:font-extrabold">High School</h1>
